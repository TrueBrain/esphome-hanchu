...
- Grid: `grid_power` (positive = import), `grid_voltage_l1`, `grid_current_l1`, `grid_frequency`, `inverter_active_power`, `inverter_reactive_power`, `power_factor`
- PV: `pv_power`, `pv_ac_power`, `pv_energy_today`, `pv_energy_total`, `pv1_voltage`, `pv1_current`, `pv2_voltage`, `pv2_current`, `pv3_voltage`, `pv3_current`
